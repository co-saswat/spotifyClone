...
import { Ionicons, Entypo, MaterialCommunityIcons, EvilIcons, FontAwesome5 } from '@expo/vector-icons';
...
// <MaterialCommunityIcons name="library-music-outline" size={24} color="black" />
